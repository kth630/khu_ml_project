...
6. validation set에서 threshold별 Precision, Recall, F1-score를 비교합니다.
7. 최종 선택한 threshold를 기준으로 test set 성능을 확인합니다.
8. Permutation Importance와 SHAP를 이용해 모델 예측 패턴을 해석합니다.
...
ROC-AUC와 PR-AUC는 모델의 전반적인 순위화 성능을 확인하기 위한 보조 지표로 사용했습니다.
